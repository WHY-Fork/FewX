        ...
        for task in sorted(tasks):
            ...
            coco_eval = (
                _evaluate_predictions_on_coco(
                    self._coco_api,  # coco api from pycocotools
                    coco_results,  # coco instance result
                    task,  # bbox
...
def _evaluate_predictions_on_coco(coco_gt, coco_results, iou_type, kpt_oks_sigmas=None):
    ...
    coco_eval = WhyCocoEval(coco_gt, coco_dt, iou_type)
